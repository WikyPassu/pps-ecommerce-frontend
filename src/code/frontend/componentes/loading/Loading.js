...
import "./Loading.css";
const Loading = () => {
    const [showLoading, setShowLoading] = useState(UtilsService.getLoading());
    UtilsService.subscribeToLoading((loading) => {
        ...
        return <>
        {
            ...
            <div className="background-loading">
                <div className="loading">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" className="svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
                        <g>
